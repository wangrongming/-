    ...
    def move_button(self):
        try:
            ...
            change_login = self.wait.until(
                EC.element_to_be_clickable((By.XPATH, '//*[@onclick="changeLogin(\'psw\');"]')))
            change_login.click()
            ...
            time.sleep(1)
            login_input = self.wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="loginbtn2"]')))
            login_input.click()
...
if __name__ == '__main__':
    url_one = "https://user.48.cn/login/index.html"
    username = "15302685068"
    password = "wangrongming123"
